...
Berdasarkan temuan dari tinjauan literatur sistematis pada Bab II yang menunjukkan efektivitas integrasi LLM, arsitektur \textit{cloud-native}, dan basis data NoSQL dalam pengembangan \textit{chatbot} cerdas di sektor logistik, bab ini menjelaskan metodologi yang diterapkan dalam mengimplementasikan temuan tersebut ke dalam sistem asisten virtual GOPOS. Metode pengembangan perangkat lunak yang diterapkan adalah \textit{Agile Development} dengan pendekatan Scrum. Pemilihan metode ini didasari oleh karakteristik proyek berbasis kecerdasan buatan (\textit{Artificial Intelligence}) yang dinamis, di mana akurasi respons AI dan logika bisnis seringkali membutuhkan penyesuaian berulang (iterasi) berdasarkan hasil uji coba.
